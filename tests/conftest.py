...
# =============================================================================
# Mock Career Stats Data
# =============================================================================

@pytest.fixture
def mock_player_career_stats():
    """Mock response from PlayerCareerStats API endpoint.
    
    This fixture provides sample career stats data for a player.
    """
    return pd.DataFrame({
        "PLAYER_ID": [2544, 2544, 2544],
        "SEASON_ID": ["2003-04", "2004-05", "2005-06"],
        "LEAGUE_ID": ["00", "00", "00"],
        "TEAM_ID": [1610612739, 1610612739, 1610612739],
        "TEAM_ABBREVIATION": ["CLE", "CLE", "CLE"],
        "PLAYER_AGE": [19, 20, 21],
        "GP": [79, 80, 79],
        "GS": [79, 80, 79],
        "MIN": [39.5, 42.4, 42.5],
        "FGM": [7.9, 8.0, 9.1],
        "FGA": [18.9, 18.8, 20.1],
        "FG_PCT": [0.417, 0.472, 0.480],
        "FG3M": [0.8, 1.4, 1.6],
        "FG3A": [2.7, 4.2, 4.8],
        "FG3_PCT": [0.290, 0.351, 0.335],
        "FTM": [4.4, 5.3, 7.3],
        "FTA": [5.8, 6.9, 9.0],
        "FT_PCT": [0.754, 0.750, 0.738],
        "OREB": [1.3, 1.4, 1.0],
        "DREB": [4.2, 5.9, 6.0],
        "REB": [5.5, 7.4, 7.0],
        "AST": [5.9, 7.2, 6.6],
