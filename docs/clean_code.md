...
- [x] Consider a common base pattern or decorator for API endpoint wrappers that handles timeouts, retries, and error logging
...
- [x] Add input validation helpers to validate common parameters (player IDs, team IDs, season strings, dates)
...
- [x] Add integration tests for each fetching module using mocked API responses
